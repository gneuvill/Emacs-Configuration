...
(define-minor-mode emacs-textmate-mode
       "Toggle Emacs-Textmate mode.
...
"     
      ...
      '(
	([backspace] . emacs-textmate-backspace2)
        ("\"" . move-over-dbl-quote)
        ("\'" . move-over-quote)
        (")" . move-over-bracket)
        ("]" . move-over-square)
...
(defun is-empty-pair ()
  (interactive)
  (eq (cdr (assoc (char-before)  emacs-textmate-pairs)) (char-after)  )
  )

(defun emacs-textmate-backspace2 ()
 (interactive)
